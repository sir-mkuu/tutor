...
<div id="frame">
	<div id="sidepanel">
		<div id="profile">
			<div class="wrap">
				<img id="profile-img" src="{{Auth::user()->profile_picture}}" class="online" alt="" />
				<p>{{Auth::user()->name}}</p>
...
<script>
        ...
        $(document).on('keyup', '.message-input input', function (e) {
            ...
            if (e.keyCode == 13 && message != '' && receiver_id != '') {
                ...
                // $('.contact.active .preview').html('<span>You: </span>' + firstWord + '...');
    ...
    function scrollToBottomFunc() {
      $('.messages').animate({
          scrollTop: $('.messages').get(0).scrollHeight}, "fast");
    ...
    $('.submit').click(function() {
      $(document).on('click', '.message-input input', function (e) {
            var message = $(this).val();
            $(this).val(''); // while pressed enter text box will be empty
